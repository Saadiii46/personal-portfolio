...
const PROJECTS = [
  {
    id: 1,
    title: "AI Courses For Kids Landing",
    category: "AI",
    ...
    <div className="min-h-screen bg-black text-white selection:bg-brand-purple/30 overflow-x-hidden">
      ...
      <header className="relative h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full">
          ...
          >
            I turn bold ideas into fast, intuitive web experiences built with
            clean architecture and zero unnecessary complexity.
          </motion.p>
      ...
      <section
        id="about"
        className="relative z-10 py-24 px-6 md:px-12 max-w-7xl mx-auto w-full overflow-hidden rounded-[48px] my-12"
      >
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={tech}
                  className="px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-xs font-medium text-white/60"
                >
                  {tech}
                </span>
              ))}
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-display font-bold">
                Currently building a Full Stack Agentic AI Application
              </h3>
            </div>
      ...
      <section id="work" className="relative z-10 py-24 overflow-hidden">
        <div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full mb-12 flex items-end justify-between">
          <div>
            <p className="text-brand-purple text-xs font-bold uppercase tracking-[0.3em] mb-4">
              Selected Works
            </p>
            ...
            >
              ...
              <div className="bg-[#0A0A0A] rounded-[32px] p-4 border border-white/5 group hover:border-brand-purple/30 transition-all duration-500">
                ...
                <div className="px-2 pb-2">
                  <h3 className="text-2xl font-display font-bold mb-1 group-hover:text-brand-purple transition-colors">
                    {project.title}
                  </h3>
      ...
      <section
        id="contact"
        className="relative z-10 py-32 px-6 md:px-12 overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              ...
              <p className="text-white/40 max-w-sm leading-relaxed mb-8">
                Building digital experiences that matter. Focused on
                high-performance applications and human-centered design.
              </p>
            </div>

            <div>
              <h4 className="font-display font-bold text-sm uppercase tracking-widest mb-6 text-white/30">
                Navigation
              </h4>
